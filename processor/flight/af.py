...
class AF(FlightSegment):
    def __init__(self, ap: str, data: list[str]):
        ...
        self.sweeping = None
        self.dme = float(data[19]) / 10
        self.start_radius = float(data[20]) / 10
    ...
    def __str__(self):
        return f"{self.record},{self.waypoint},{self.latitude},{self.longitude},{self.steering},{self.nav_station},{self.sweeping},{self.dme},{self.start_radius},{self.height_lim},{self.height_1},{self.height_2},{self.speed_lim},{self.speed_1},{self.speed_2},{self.special},{self.passthrough}"
