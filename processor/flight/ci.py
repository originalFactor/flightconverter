...
class CI(FlightSegment):
    ...
    def __str__(self):
        return f"{self.record},{self.steering},{self.nav_station},{self.azimuth},{self.heading},{self.height_lim},{self.height_1},{self.height_2},{self.speed_lim},{self.speed_1},{self.speed_2},{self.special},{self.passthrough}"
