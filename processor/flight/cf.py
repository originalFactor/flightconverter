...
class CF(FlightSegment):
    def __init__(self, ap: str, data: list[str]):
        ...
        self.distance_2 = float(data[21]) / 10
    ...
    def __str__(self):
        return f"{self.record},{self.waypoint},{self.latitude},{self.longitude},{self.steering},{self.nav_station},{self.azimuth},{self.distance},{self.heading},{self.distance_2},{self.height_lim},{self.height_1},{self.height_2},{self.speed_lim},{self.speed_1},{self.speed_2},{self.special},{self.passthrough}"
